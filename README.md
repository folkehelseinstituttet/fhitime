...
`fhitime` provides convenient and consistent conversion between 
- isoyear
- isoweek
- calyear
- season week
...
| [fhitime](https://folkehelseinstituttet.github.io/fhitime) 	| Helpful functions for datetime conversions suitable for public health.  |
